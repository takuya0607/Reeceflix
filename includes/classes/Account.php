...
class Account {
  ...
  {
    // private $conに対して、PDOアクセス変数の$conを渡す
    $this->con = $con;
  }
  ...
  // privateに設定する事で、このクラス内からしかアクセス出来ないようにする
  ...
  private function validateUsername($un)
  {
    if(strlen($un) < 2 || strlen($un) >25){
      ...
      // validationの処理で引っ掛かれば、その時点でreturnをして終了
      return;
    }
